...
CI chạy các gate frontend và backend ở trên cho mọi Pull Request. Nếu sửa `src-tauri/`, hãy chạy thêm:
...
Workflow hiện tại chưa có Rust job, nên hai lệnh này là kiểm tra cục bộ bắt buộc cho thay đổi Tauri.
