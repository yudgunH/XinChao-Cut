...
- Dùng tính năng **[Private vulnerability reporting](https://docs.github.com/en/code-security/security-advisories/guidance-on-reporting-and-writing-information-about-vulnerabilities/privately-reporting-a-security-vulnerability)** của GitHub (tab *Security* của repo), hoặc
...
- Dữ liệu media và project được lưu cục bộ trong trình duyệt (OPFS/IndexedDB) và thư mục `.work/` của backend — không gửi đi đâu trừ khi bạn tự cấu hình.
